...
declare module _ {
  ...
  interface ObjectIterator<T, TResult, U extends Dictionary<T> = Dictionary<T>> {
    (element: T, key: keyof U, object: Dictionary<T>): TResult;
  }

  type ObjectMatcher<T> = Predicate<T> | Partial<T>
  ...
  interface MemoObjectIterator<T, TResult, U extends Dictionary<T> = Dictionary<T>> {
    (prev: TResult, curr: T, key: keyof U, list: U): TResult;
  }
  ...
  interface UnderscoreStatic {
     ...
     **/<T>(value: _.List<T>): UnderscoreList<T, _.List<T>>;

    <T>(value: Array<T>): UnderscoreList<T, Array<T>>;

    <T extends TypeOfDictionary<V>, V extends _.Dictionary<any> = _.Dictionary<T>>(value: V): UnderscoreDictionary<T, V>;
     ...
     * @param iterator Truth test iterator function for each element in `list`.
     * @param context `this` object in `iterator`, optional.
     ...
     * @param fromIndex The index to start the search from within `list`.
     ...
     * @param args Additional arguments to pass to the method `methodName`.
     **/
    invoke<T extends {}>(
      list: _.List<T>,
      methodName: string,
     ...
     * @see _.countBy
     * @param list Group elements in this list and then count the number of elements in each group.
     * @param iterator name of the property used to group each element
     * @param context `this` object in `iterator`, optional.
     **/
    countBy<T>(
      list: _.List<T>,
    ...
    /**
     * @see _.first
     * @param array Retrieves the first n elements of this array.
    ...
    /**
     * @see _.last
     * @param array Retrieves the last n elements of this array.
     ...
     * @param args Additional arguments to pass to `fn` when called.
     ...
     * @param p1 The partial arguments.
     ...
     * @param fn The function to defer execution `count` times.
     ...
     * @param count The maxmimum number of times the function can be called.
     * @param fn The function to limit the number of times it can be called.
     ...
     * @param predicate (...args: any[]) => boolean
     * @return (...args: any[]) => boolean
     **/
    negate<T>(predicate: Predicate<T>): Predicate<T>;
     ...
     */
    mapObject<T, U>(object: _.Dictionary<T>, iteratee: ObjectIterator<T, U>, context?: any): _.Dictionary<U>;
    ...
    mapObject<T, U, K = keyof T>(object: T, iteratee: (val: T[K], key: K, object: any) => U, context?: any): { [key in K]: U };
     ...
     * @param context The optional context (value of `this`) to bind to
     */
    mapObject<T, K extends keyof T = keyof T>(object: _.Dictionary<T>, iteratee: K, context?: any): _.Dictionary<T[K]>;
     ...
     **/
    pairs<V, K extends keyof V = keyof V>(object: V): [K, V[K]][];
     ...
     **/
    invert<V, K extends keyof V = keyof V>(object: V): { [key: V[K]]: K };
     ...
     **/
    functions<V, K extends keyof V>(object: V): (V[K] extends Function ? K : never)[];

    /**
     * @see _functions
     **/
    methods<V, K extends keyof V>(object: V): (V[K] extends Function ? K : never)[];
     ...
     * @param obj Object to strip unwanted key/value pairs.
     * @param keys The key/value pairs to keep on `object`.
     ...
     * (or array of valid keys).
     * @param obj Object to strip unwanted key/value pairs.
     * @param predicate A matcher for the values of `object`.
     * @return Copy of `object` with only the `keys` properties.
     **/
    pick<T>(obj: _.Dictionary<T>, predicate: ObjectIterator<T, boolean>): _.Dictionary<T>;
     ...
     * @return Copy of `object` with only the `keys` properties.
     **/
    pick<T, U extends _.Collection<T>>(obj: U, predicate: ObjectIterator<T, boolean, U>): _.Dictionary<T>;
     ...
     * @param value Check if this object is undefined.
     ...
     * @param value string|Function|Object value The value to iterate over, usually the key.
     * @return Callback that can be applied to each element in a collection.
     **/
    iteratee<T, K extends keyof T>(value: K): ObjectIterator<T, T[K]>;

    iteratee(): <T>(value: T) => T;

    iteratee(value: Function, context?: any): Function;

    iteratee<T>(value: ObjectMatcher<T>): ObjectIterator<T, boolean>;
  ...
  interface Underscore<T, V = T> {
     ...
     * @see _.findWhere
     **/
    findWhere<U extends { [key in keyof T]?: T[key] }>(properties: U): T | undefined;
     ...
     * @see _.sortBy
     **/
    sortBy(iterator: keyof T, context?: any): T[];
     ...
     * @see _.groupBy
     **/
    groupBy(iterator: keyof T, context?: any): _.Dictionary<T[]>;
     ...
     * @see _.defaults
     **/
    defaults<U extends Partial<T>>(...defaults: U): U & T;
     ...
     * @see _.tap
     **/
    tap(interceptor: (as: T) => any): T;

    /**
     * Wrapped type `any[]`.
     * @see _.matches
     **/
    matches(): _.Predicate<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.matcher
     **/
    matcher(): _.Predicate<T>;
  ...
  interface UnderscoreList<T, V = T[]> extends Underscore<T, V> {
     ...
     * @see _.find
     **/
    find<T, U extends {}>(iterator: U): T | undefined;

    /**
     * @see _.find
     **/
    find<T>(iterator: string): T | undefined;
     ...
     * @see _.flatten
     **/
    flatten<Type extends T>(shallow?: boolean): _.Flatten<Type>[];
     ...
     * @see _.partition
     **/
    partition<U>(iterator: (value: T, index: number, context: U) => boolean, context?: U): T[][];

    /**
     * @see _.partition
     **/
    partition(iterator: _.ObjectMatcher<T>): T[][];
     ...
     * @see _.uniq
     **/
    uniq(isSorted?: boolean, iterator?: _.ListIterator<T, any> | keyof T): T[];
     ...
     * @see _.unzip
     **/
    unzip(): T extends [infer U, infer W][] ? [U[], W[]] : never;
     ...
     * @see _.object
     **/
    object(): T extends [infer U, infer W][] ? { [key: U]: W } : never;

    /**
     * @see _.object
     **/
    object<W>(array: W[]): { [key: T]: W }
     ...
     * @see _.findIndex
     **/
    findIndex(predicate: _.ObjectMatcher<T>): number;

    /**
     * @see _.findIndex
     **/
    findIndex<U>(predicate: (value: T, index: number, context: U) => boolean, context?: U): number;

    /**
     * Wrapped type `any[]`.
     * @see _.findLastIndex
     **/
    findLastIndex(predicate: _.ObjectMatcher<T>): number;

    /**
     * @see _.findLastIndex
     **/
    findLastIndex<U>(predicate: (value: T, index: number, context: U) => boolean, context?: U): number;
     ...
     * @see _.sortedIndex
     **/
    sortedIndex(value: T, sortBy: keyof T): number;

    /**
     * @see _.sortedIndex
     **/
    sortedIndex<U>(value: T, sortBy: (value: T, index: number, context: U) => number, context?: U): number;
  ...
  interface UnderscoreDictionary<T, V> extends Underscore<T, V> {
     ...
     * @see _.each
     **/
    each(iterator: _.ObjectIterator<T, void, V>, context?: any): _.List<T>;

    /**
     * @see _.each
     **/
    forEach(iterator: _.ObjectIterator<T, void, V>, context?: any): _.List<T>;

    /**
     * Wrapped type `any{}`.
     * @see _.map
     **/
    map<TResult>(iterator: _.ObjectIterator<T, TResult, V>, context?: any): TResult[];

    /**
     * @see _.map
     **/
    collect<TResult>(iterator: _.ObjectIterator<T, TResult, V>, context?: any): TResult[];

    /**
     * Wrapped type `any{}`.
     * @see _.reduce
     **/
    reduce<TResult>(iterator: _.MemoObjectIterator<T, TResult, V>, memo?: TResult, context?: any): TResult;

    /**
     * @see _.reduce
     **/
    inject<TResult>(iterator: _.MemoObjectIterator<T, TResult, V>, memo?: TResult, context?: any): TResult;

    /**
     * @see _.reduce
     **/
    foldl<TResult>(iterator: _.MemoObjectIterator<T, TResult, V>, memo?: TResult, context?: any): TResult;

    /**
     * Wrapped type `any[]`.
     * @see _.reduceRight
     **/
    reduceRight<TResult>(iterator: _.MemoObjectIterator<T, TResult, V>, memo?: TResult, context?: any): TResult;

    /**
     * @see _.reduceRight
     **/
    foldr<TResult>(iterator: _.MemoObjectIterator<T, TResult, V>, memo?: TResult, context?: any): TResult;

    /**
     * Wrapped type `any{}`.
     * @see _.find
     **/
    find(iterator: _.ObjectIterator<T, boolean, V>, context?: any): T | undefined;

    /**
     * @see _.find
     **/
    find(iterator: _.ObjectMatcher<T>): T | undefined;
     ...
     * @see _.mapObject
     **/
    mapObject<U>(fn: ObjectIterator<T, U, V>): { [key in keyof V]: U };

    /**
     * @see _.pairs
     **/
    pairs<K extends keyof V = keyof V>(): [K, V[K]][];

    /**
     * @see _.invert
     **/
    invert<K extends keyof V = keyof V>(): { [key: V[K]]: K };

    /**
     * @see _.functions
     **/
    functions<K extends keyof V = keyof V>(): (V[K] extends Function ? K : never)[];

    /**
     * @see _.functions
     **/
    methods<K extends keyof V = keyof V>(): (V[K] extends Function ? K : never)[];
     ...
     * @see _.extend
     **/
    findKey(predicate: _.ObjectIterator<T, boolean, V>, context?: any): keyof V
    ...
    // pick<K extends keyof V>(predicate: ObjectMatcher<V[K]>): Pick<V, K>;

    /**
     * @see _.omit
     **/
    omit<K extends keyof V>(key: K): Omit<V, K>;

    omit<K extends keyof V>(...keys: K[]): Omit<V, K>;

    omit<K extends keyof V>(keys: K[]): Omit<V, K>;

    omit<K extends keyof V>(fn: ObjectIterator<V[K], boolean>): Omit<V, K>;
  ...
  interface _ArrayChain<T> extends _Chain<T, T[]> {
     ...
     * @see _.each
     **/
    each(iterator: _.ListIterator<T, void>, context?: any): _ArrayChain<T>;

    /**
     * @see _.each
     **/
    forEach(iterator: _.ListIterator<T, void>, context?: any): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.map
     **/
    map<TResult>(iterator: _.ListIterator<T, TResult>, context?: any): _ArrayChain<TResult>;

    /**
     * @see _.map
     **/
    collect<TResult>(iterator: _.ListIterator<T, TResult>, context?: any): _ArrayChain<TResult>;

    /**
     * Wrapped type `any[]`.
     * @see _.reduce
     **/
    reduce<TResult>(iterator: _.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult extends _.List<infer L> ? _ArrayChain<L> : _Chain<TResult>;

    /**
     * @see _.reduce
     **/
    inject<TResult>(iterator: _.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult extends _.List<infer L> ? _ArrayChain<L> : _Chain<TResult>;

    /**
     * @see _.reduce
     **/
    foldl<TResult>(iterator: _.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult extends _.List<infer L> ? _ArrayChain<L> : _Chain<TResult>;

    /**
     * Wrapped type `any[]`.
     * @see _.reduceRight
     **/
    reduceRight<TResult>(iterator: _.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult extends _.List<infer L> ? _ArrayChain<L> : _Chain<TResult>;

    /**
     * @see _.reduceRight
     **/
    foldr<TResult>(iterator: _.MemoIterator<T, TResult>, memo?: TResult, context?: any): TResult extends _.List<infer L> ? _ArrayChain<L> : _Chain<TResult>;

    /**
     * Wrapped type `any[]`.
     * @see _.find
     **/
    find<T>(iterator: _.ListIterator<T, boolean>, context?: any): _Chain<T | undefined>;

    /**
     * @see _.find
     **/
    find(iterator: Partial<T>): _Chain<T | undefined>;

    /**
     * @see _.find
     **/
    find(iterator: string): _Chain<T | undefined>;

    /**
     * @see _.find
     **/
    detect(iterator: _.ListIterator<T, boolean>, context?: any): _Chain<T | undefined>;

    /**
     * @see _.find
     **/
    detect(iterator: Partial<T>): _Chain<T | undefined>;

    /**
     * @see _.find
     **/
    detect(iterator: string): _Chain<T | undefined>;

    /**
     * Wrapped type `any[]`.
     * @see _.filter
     **/
    filter(iterator: _.ListIterator<T, boolean>, context?: any): _ArrayChain<T>;

    /**
     * @see _.filter
     **/
    select(iterator: _.ListIterator<T, boolean>, context?: any): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.where
     **/
    where(properties: Partial<T>): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.findWhere
     **/
    findWhere(properties: Partial<T>): _Chain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.reject
     **/
    reject(iterator: _.ListIterator<T, boolean>, context?: any): _ArrayChain<T>;
     ...
     * @see _.invoke
     **/
    invoke(methodName: string, ...args: any[]): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.pluck
     **/
    pluck<K extends keyof T = keyof T>(propertyName: K): _ArrayChain<T[K]>;
     ...
     * @see _.sortBy
     **/
    sortBy<TSort>(iterator?: _.ListIterator<T, TSort>, context?: any): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.sortBy
     **/
    sortBy(iterator: keyof T, context?: any): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.groupBy
     **/
    groupBy(iterator?: _.ListIterator<T, any>, context?: any): _Chain<_.Dictionary<T[]>>;

    /**
     * Wrapped type `any[]`.
     * @see _.groupBy
     **/
    groupBy(iterator: keyof T, context?: any): _Chain<_.Dictionary<T[]>>;

    /**
     * Wrapped type `any[]`.
     * @see _.indexBy
     **/
    indexBy(iterator: _.ListIterator<T, any>, context?: any): _Chain<_.Dictionary<T>>;

    /**
     * Wrapped type `any[]`.
     * @see _.indexBy
     **/
    indexBy(iterator: keyof T, context?: any): _Chain<_.Dictionary<T>>;

    /**
     * Wrapped type `any[]`.
     * @see _.countBy
     **/
    countBy(iterator?: _.ListIterator<T, any>, context?: any): _Chain<_.Dictionary<number>>;

    /**
     * Wrapped type `any[]`.
     * @see _.countBy
     **/
    countBy(iterator: keyof T, context?: any): _Chain<_.Dictionary<number>>;

    /**
     * Wrapped type `any[]`.
     * @see _.shuffle
     **/
    shuffle(): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.sample
     **/
    sample(n: number): _ArrayChain<T>;
     ...
     * @see _.first
     **/
    first(n: number): _ArrayChain<T>;

    /**
     * @see _.first
     **/
    head(): _Chain<T | undefined>;

    /**
     * @see _.first
     **/
    head(n: number): _ArrayChain<T>;

    /**
     * @see _.first
     **/
    take(): _Chain<T | undefined>;

    /**
     * @see _.first
     **/
    take(n: number): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.initial
     **/
    initial(n?: number): _ArrayChain<T>;
     ...
     * @see _.last
     **/
    last(n: number): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.rest
     **/
    rest(n?: number): _ArrayChain<T>;

    /**
     * @see _.rest
     **/
    tail(n?: number): _ArrayChain<T>;

    /**
     * @see _.rest
     **/
    drop(n?: number): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.compact
     **/
    compact(): _ArrayChain<T>;

    /**
     * Wrapped type `any`.
     * @see _.flatten
     **/
    flatten(shallow?: boolean): T extends _.List<infer L> ? _ArrayChain<L> : _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.without
     **/
    without(...values: T[]): _ArrayChain<T>;
     ...
     * @see _.union
     **/
    union(...arrays: _.List<T>[]): _ArrayChain<T>;

    /**
     * Wrapped type `any[][]`.
     * @see _.intersection
     **/
    intersection(...arrays: _.List<T>[]): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.difference
     **/
    difference(...others: _.List<T>[]): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.uniq
     **/
    uniq(isSorted?: boolean, iterator?: _.ListIterator<T, any> | _.IterateePropertyShorthand): _ArrayChain<T>;

    /**
     * Wrapped type `any[]`.
     * @see _.uniq
     **/
    uniq<TSort>(iterator?: _.ListIterator<T, TSort> | _.IterateePropertyShorthand, context?: any): _ArrayChain<T>;

    /**
     * @see _.uniq
     **/
    unique<TSort>(isSorted?: boolean, iterator?: _.ListIterator<T, TSort> | _.IterateePropertyShorthand): _ArrayChain<T>;

    /**
     * @see _.uniq
     **/
    unique<TSort>(iterator?: _.ListIterator<T, TSort> | _.IterateePropertyShorthand, context?: any): _ArrayChain<T>;

    /**
     * Wrapped type `any[][]`.
     * @see _.zip
     **/
    zip(...arrays: any[][]): _ArrayChain<T>;

    /**
     * Wrapped type `any[][]`.
     * @see _.unzip
     **/
    unzip(...arrays: any[][]): _ArrayChain<T>;

    /**
     * Wrapped type `any[][]`.
     * @see _.object
     **/
    object<K, V>(...keyValuePairs: [K, V][]): _Chain<{ [k: K]: V }>;

    /**
     * @see _.object
     **/
    object<V>(values?: _.List<V>): _Chain<{ [k: T]: V }>;
     ...
     * @see _.findIndex
     **/
    findIndex(predicate: _.ListIterator<T, boolean> | Partial<T>, context?: any): _Chain<number>;

    /**
     * @see _.findLastIndex
     **/
    findLastIndex(predicate: _.ListIterator<T, boolean> | Partial<T>, context?: any): _Chain<number>;

    /**
     * Wrapped type `any[]`.
     * @see _.sortedIndex
     **/
    sortedIndex<TSort>(value: T, iterator?: (item: T) => TSort | string, context?: any): _Chain<number>;

    /**
     * Wrapped type `any[][]`.
     * @see _.chunk
     **/
    chunk(count: number): _ArrayChain<T[]>;
     ...
     **/
    join(separator?: any): _Chain<string>;
     ...
     **/
    push(...item: T[]): _ArrayChain<T>;

    /**
     * Reverses an array in place. The first array element becomes the last and the last becomes the first.
     * @return The reversed array.
     **/
    reverse(): _ArrayChain<T>;
     ...
     **/
    slice(start: number, end?: number): _ArrayChain<T>;
     ...
     **/
    sort(compareFn?: (a: T, b: T) => (1 | 0 | -1)): _ArrayChain<T>;
     ...
     **/
    splice(index: number, quantity: number, ...items: T[]): _ArrayChain<T>;
  ...
  interface _Chain<T, V = T> {
     ...
     * @see _.map
     **/
    map<TResult>(iterator: _.ObjectIterator<T, TResult>, context?: any): _ArrayChain<TResult>;
     ...
     * @see _.map
     **/
    collect<TResult>(iterator: _.ObjectIterator<T, TResult>, context?: any): _ArrayChain<TResult>;
     ...
     * @see _.find
     **/
    find<T, U extends {}>(iterator: U): _Chain<T | undefined>;

    /**
     * @see _.find
     **/
    find<T>(iterator: string): _Chain<T | undefined>;
     ...
     * @see _.filter
     **/
    filter(iterator: _.ObjectIterator<T, boolean>, context?: any): _ArrayChain<T>;

    /**
     * @see _.filter
     **/
    select(iterator: _.ObjectIterator<T, boolean>, context?: any): _ArrayChain<T>;
     ...
     * @see _.pluck
     **/
    pluck<K extends keyof T>(propertyName: K): V extends _.List<T> ? _ArrayChain<T[K]> : _Chain<T[K]>;
     ...
     * @see _.compact
     **/
    compact(): V extends _.List<T> ? _Chain<T, _.List<T>> : _Chain<T>;
     ...
     * @see _.uniq
     **/
    uniq(isSorted?: boolean, iterator?: _.ListIterator<T, any> | _.IterateePropertyShorthand): _Chain<T, V>;

    /**
     * Wrapped type `any[]`.
     * @see _.uniq
     **/
    uniq<TSort>(iterator?: _.ListIterator<T, TSort> | _.IterateePropertyShorthand, context?: any): _Chain<T, V>;

    /**
     * @see _.uniq
     **/
    unique<TSort>(isSorted?: boolean, iterator?: _.ListIterator<T, TSort> | _.IterateePropertyShorthand): _Chain<T, V>;

    /**
     * @see _.uniq
     **/
    unique<TSort>(iterator?: _.ListIterator<T, TSort> | _.IterateePropertyShorthand, context?: any): _Chain<T, V>;
     ...
     * @see _.values
     **/
    values(): V extends _.Dictionary<T> ? _ArrayChain<T> : _ArrayChain<any>;

    /**
     * Wrapped type `object`.
     * @see _.mapObject
     **/
    mapObject<TResult>(fn: _.ObjectIterator<T, TResult>): V extends _.Dictionary<T> ? _Chain<{ [key in keyof V]: TResult }> : _Chain<T>;
     ...
     * @see _.functions
     **/
    functions<K extends keyof T>(): _ArrayChain<T[K] extends Function ? K : never>;

    /**
     * @see _.functions
     **/
    methods<K extends keyof T>(): _ArrayChain<T[K] extends Function ? K : never>;
     ...
     * @see _.defaults
     **/
    defaults<U extends {}>(defaults: U): _Chain<T & U>;
