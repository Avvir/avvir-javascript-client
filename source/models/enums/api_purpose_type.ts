export enum ApiProjectPurposeType {
  ...
  BIM_MASTERFORMAT_PREDICTIONS_TSV = "BIM_MASTERFORMAT_PREDICTIONS_TSV",
  BIM_MASTERFORMAT_CORRECTIONS_TSV = "BIM_MASTERFORMAT_CORRECTIONS_TSV"
}
...
const ApiPurposeType = {
  ...
  POTREE2: ApiScanDatasetPurposeType.POTREE2,
  /** @deprecated */
  ...
  BIM_MASTERFORMAT_PREDICTIONS_TSV: ApiProjectPurposeType.BIM_MASTERFORMAT_PREDICTIONS_TSV,
  BIM_MASTERFORMAT_CORRECTIONS_TSV: ApiProjectPurposeType.BIM_MASTERFORMAT_CORRECTIONS_TSV,
