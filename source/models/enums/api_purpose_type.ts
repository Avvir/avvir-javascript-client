...
const ApiPurposeType = {
  ...
  MASTERFORMAT_PREDICTIONS_TSV: ApiProjectPurposeType.MASTERFORMAT_PREDICTIONS_TSV,
  MASTERFORMAT_CORRECTIONS_TSV: ApiProjectPurposeType.MASTERFORMAT_CORRECTIONS_TSV,
