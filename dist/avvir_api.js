...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": () => /* binding */ check_fetch_status
});
...
var checkFetchStatus = function checkFetchStatus(response) {
  var requestPath = response.url.split(http.default.baseUrl).join("..."); // split and join to replace text
  ...
  if (response.ok) {
    ...
    return response.json().then(function (errorBody) {
      ...
      var error = new response_error.default(message, verboseMessage, response, errorBody);
      console.error(error);
      throw error;
    });
  }
...
/* harmony import */ var underscore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2164);
/* harmony import */ var underscore__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(underscore__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _check_fetch_status__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7513);
...
var map = {
	...
	"./utilities/check_fetch_status.ts": 7513,
