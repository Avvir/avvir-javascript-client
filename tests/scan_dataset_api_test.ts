...
describe("ScanDatasetApi", () => {
  ...
  describe("#getScanDataset", () => {
    beforeEach(() => {
      fetchMock.get(`${WebGatewayApi.baseUrl}/projects/some-project-id/floors/some-floor-id/scan-datasets/some-scan-id`, 200);
    });
    ...
    it("makes an authenticated call to the scan dataset endpoint", () => {
      ...
      expect(fetchCall[0]).to.eq(`${WebGatewayApi.baseUrl}/projects/some-project-id/floors/some-floor-id/scan-datasets/some-scan-id`);
  ...
  describe("#createScanDataset", () => {
    ...
    it("makes an authenticated call to the scan dataset creation endpoint", () => {
      ...
      expect(fetchCall[0]).to.eq(`${WebGatewayApi.baseUrl}/projects/some-project-id/floors/some-floor-id/scan-datasets`);
      expect(lastFetchOpts.headers).to.include.keys("firebaseIdToken");
      expect(lastFetchOpts.headers.firebaseIdToken).to.eq("some-firebase.id.token");
    });
  ...
  describe("#saveScanAnalysis", () => {
    ...
    it("makes a call to the scan analysis endpoint", () => {
      ...
      expect(fetchCall[0]).to.eq(`${WebGatewayApi.baseUrl}/projects/some-project-id/floors/some-floor-id/scan-datasets/some-scan-id/analysis?enforceBuiltPersistence=false`);
  ...
  describe("#listScanDatasetsForFloor", () => {
    beforeEach(() => {
      fetchMock.get(`${WebGatewayApi.baseUrl}/projects/some-project-id/floors/some-floor-id/scan-datasets`, 200);
    });
  ...
  describe("#updateScanDataset", () => {
    beforeEach(() => {
      fetchMock.patch(`${WebGatewayApi.baseUrl}/projects/some-project-id/floors/some-floor-id/scan-datasets/some-scan-dataset-id`, 200);
    });
...
0 0 0 5.7777`,
  ...
  describe("#deleteScanDataset", () => {
    beforeEach(() => {
      fetchMock.delete(`${WebGatewayApi.baseUrl}/projects/some-project-id/floors/some-floor-id/scan-datasets/some-scan-dataset-id`, 200);
    });
  ...
  describe("#getViewerDetailedElementsForScanDataset", () => {
    beforeEach(() => {
      fetchMock.get(`${WebGatewayApi.baseUrl}/projects/some-project-id/floors/some-floor-id/scan-datasets/some-scan-dataset-id/detailed-elements/viewer`, 200);
    });
  ...
  describe("#getProgressReportForScanDataset", () => {
    beforeEach(() => {
      fetchMock.get(`${WebGatewayApi.baseUrl}/projects/some-project-id/floors/some-floor-id/scan-datasets/some-scan-dataset-id/progress`, 200);
    });
